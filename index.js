...
function miles(numKm) {
  var numKm = numKm * 0.621371;
  var x = numKm.toFixed(5);
  var x = parseFloat(x);
  return x;
}
...
function feet(numCm) {
  var numCm = numCm / 30.48;
  numCm = parseFloat(numCm);
  return numCm;
}
...
function grade(/*add your code here*/ pct) {
  /*add your code here*/
  if (pct >= 90 && pct <= 100) {
    return "you got an A";
